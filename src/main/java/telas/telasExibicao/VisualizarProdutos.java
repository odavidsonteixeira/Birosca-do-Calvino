...
public class VisualizarProdutos extends javax.swing.JFrame {
     ...
     */
    public VisualizarProdutos() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarProdutos.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(VisualizarProdutos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
