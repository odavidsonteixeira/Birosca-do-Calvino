 ...
 * @author Davidson
 */
public class VisualizarSaldoAcampantes extends javax.swing.JFrame {

    /**
     * Creates new form TelaCompra
     */
    public VisualizarSaldoAcampantes() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarSaldoAcampantes.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new VisualizarSaldoAcampantes().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(VisualizarSaldoAcampantes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
